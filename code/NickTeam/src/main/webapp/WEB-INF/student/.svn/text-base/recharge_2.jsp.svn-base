...
<script type="text/javascript" src="<%=path%>/resource/local/js/student/recharge_2.js"></script>
</head>
<body>
	<div id="index-bg">
		<div class="content">
				...
				<div class="right-content">
						...
						<div class="icon-info">
							<ul>
								<li class="pages-apply">
									<h5>
										<b class="b-red"><s class="s-cat-21"></s>充值－凭证管理</b>&nbsp;&nbsp;&nbsp;<span class="font-12">Recharge Ticket</span>
									</h5>
								</li>
							</ul>
					...
					<div class="right-content-main">
						...
						<div class="recharge-step">
							<form id="recharge_image_upload_form" action="#" method="post" enctype="multipart/form-data">
								<input name="detailId" type="hidden" value=${detailId } />
		                    	<div class="clear" style="height:20px;"></div>
		                    	<h5>账户充值</h5>
		                        <div class="recharge-input">
		                        	<label>上传付款凭证：&nbsp;&nbsp;<input name="file" class="easyui-filebox" style="width:300px"></label>
		                        	<div class="clear"></div>
		                        </div>
		                        <div class="recharge-submit">
		                        	...
		                        	<a href="javascript:void(0);" onclick="javascript:toFinishRecharge();" class="x-small a-red" style="float:right;">下一步 完成上传</a>
		                        </div>
	                        </form>
                        </div>
	...
	<!-- 隐藏域 -->
	<input id="page_detailId" type="hidden" value="${detailId }" />
</body>
</html>