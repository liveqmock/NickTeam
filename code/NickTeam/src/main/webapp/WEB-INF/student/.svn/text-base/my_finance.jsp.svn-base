						...
						<div class="icon-info">
							<ul>
								<li class="pages-apply">
									<h5>
										<b class="b-red"><s class="s-cat-21"></s>财富账户</b>&nbsp;&nbsp;&nbsp;<span class="font-12">Finance Account</span>
									</h5>
								</li>
							</ul>
					...
					<div class="right-content-message">
                        ...
                        <div class="user-residue" style="margin-left: 20px;">
                         ...
                         <div class="recharge-btn">
                         	...
                         	<a href="javascript:void(0);" onclick="javascript:toWithdraw();" class="x-small a-blue">取现</a>
                         </div>
                    </div>
					<!-- 页面内容部分 -->
