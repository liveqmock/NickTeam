...
<body>
			...
			<div class="center apply-pages" style="background: #f6f6f6;">
				...
				<div class="right-content">
					...
					<div class="record password">
						<div>
							<p style="float: left;" class="b-blue">通行证信息</p>
					...
					<div class="record-one record-two">
						...
						<table cellspacing="10">
							...
							<tr>
								<td width="10%;" style="text-align: right;">曾读高中</td>
								<td width="10%;" style="text-align: left;">
	...
	<!-- 弹出框 开始 -->
	<!-- 更新通行证 -->
	<div id="update_passport_dialog" style="display: none;" title="更新通行证">
		<form id="update_passport_form" action="#" method="post">
			...
			<div class="t_center">
				<a href="javascript:void(0);" onclick="javascript:doAjaxUpdatePassport();" class="easyui-linkbutton t_center">保存通行证修改</a>
			</div>
		</form>
	</div>
	
	<!-- 更新基础信息 -->
	<div id="update_base_info_dialog" style="display: none;" title="更新通行证">
		<form id="update_base_info_form" action="#" method="post">
			...
			<table style="padding: 10px"  cellspacing="10">
				...
				<tr>
					<td width="16%" style="text-align: right;">曾读高中:</td>
					<td width="16%" style="text-align: left;">
