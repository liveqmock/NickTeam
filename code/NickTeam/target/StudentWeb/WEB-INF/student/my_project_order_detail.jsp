...
<body>
								...
								<li class="pages-apply">
									<h5>
										<b class="b-red"><s class="s-cat-21"></s>我的订单详细</b>&nbsp;&nbsp;&nbsp;<span
											class="font-12">Project Order Detail</span>
									</h5>
								</li>
							</ul>
						...
						<div class="apply-step">
							...
							<div class="xq-center">
								<div class="xq-center-auto">
									...
									<div class="xq_time">
										项目时间：<span id="v_sub_project_time"></span>&nbsp;&nbsp;&nbsp;&nbsp;实习公司：<span id="v_holder_name"></span>
									</div>
									<div class="xq_time">
	...
	<div id="interview_info_dialog" style="display: none;" title="面试信息">
		<div class="after-title">
            ...
            <div class="title-message">
                <dl>
                    <dt>真实姓名：<span class="t_c_gray" id="v_interviewer_trueName"></dt>
                </dl>
                <dl>
	...
	<div id="project_all_fee_pay_dialog" style="display: none;" title="项目费用付款信息">
		...
		<div class="after-title">
            ...
            <div class="">
                <dl>
                    <dt>项目费用：<span class="t_c_gray" id="v_p_a_f_costs"></span></dt>
                </dl>
            </div>
