...
<script type="text/javascript" src="<%=path%>/resource/local/js/student/recharge_1.js"></script>
</head>
<body>
	<div id="index-bg">
		<div class="content">
				...
				<div class="right-content">
						...
						<div class="icon-info">
							<ul>
								<li class="pages-apply">
									<h5>
										<b class="b-red"><s class="s-cat-21"></s>充值－金额管理</b>&nbsp;&nbsp;&nbsp;<span class="font-12">Recharge How Much</span>
									</h5>
								</li>
							</ul>
					...
					<div class="right-content-main">
                    	...
                    	<form id="recharge_form" action="#" method="post">
                    		...
                    		<input name="financeAccountDetail.type" type="hidden" value="recharge" />
							...
							<div class="recharge-step">
		                        ...
		                        <div class="recharge-submit">
		                        	...
		                        	<a href="javascript:void(0);" onclick="javascript:doAjaxRecharge();" class="x-small a-red">下一步 提交凭证</a>
		                        </div>
		                    </div>
	                    </form>
